...
class lxn extends NavSystemTouch {
    ...
    initSystemSettings() {
        ...
        let brightessrange = new rangeinput(document.querySelector("#brightnesslider"), function(val) { SimVar.SetSimVarValue("L:NAV_BRIGHTNESS", "", val); document.querySelector("#output").innerHTML = val; });
