...
<h3>Conditional Data Fields</h3>

There are two new, special dataflied options available: "Waypoint Min" and "Waypoint Max". These will display Min/Max Altitudes for the current waypoint if set in the flightplan. If no value is present, the datafield will be completely invisible. So 
